...
import requests
import re
url = 'https://www.douyin.com/user/MS4wLjABAAAAjbYArk8QCfwPYui_lYqmcZV0CsFe4Hf4UJA5Vtaf5m_eSEiGTjQt8fEkathqBsct?modal_id=7280842027959471412&relation=0&vid=7218875203173027112'
headers = {
...
video_info = re.findall('<script id="RENDER_DATA" type="application/json">(.*?)</script', response.text)
